...
<svg data-template="vitals" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Token Stats usage signals for @${escapeXml(data.user.username)}">
  ${cardTextStyle()}
