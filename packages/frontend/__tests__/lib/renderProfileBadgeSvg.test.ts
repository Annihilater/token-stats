...
describe("renderProfileBadgeSvg", () => {
  it("renders a valid SVG with default metric (tokens)", () => {
    ...
    expect(svg).toContain("</svg>");
    expect(svg).toContain("Token Stats Tokens");
  ...
  it("renders cost metric", () => {
    ...
    expect(svg).toContain("Token Stats Cost");
  ...
  it("renders rank metric", () => {
    ...
    expect(svg).toContain("Token Stats Rank");
  ...
  it("accepts custom label", () => {
    ...
    expect(svg).not.toContain("Token Stats Tokens");
  });
  ...
  it("includes accessible title element", () => {
    ...
    expect(svg).toContain("Token Stats Tokens: 1,234,567");
  });

  it("includes aria-label attribute", () => {
    const svg = renderProfileBadgeSvg(mockStats);

    expect(svg).toContain('aria-label="Token Stats Tokens: 1,234,567"');
  });
...
describe("renderBadgeErrorSvg", () => {
  ...
  it("supports custom label for error badge", () => {
    ...
    expect(svg).not.toContain("Token Stats");
  });
